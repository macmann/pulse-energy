# Welcome to Enpal Pulse

Your home makes, stores, and uses energy in dozens of ways every hour — solar on the roof, a battery charging and draining, a heat pump, the car, and a tariff whose price changes through the day. Pulse pulls all of that into one place and tells you, in plain words, what's happening and what to do about it.

This guide walks you through what each part does and how they fit together.

## The idea in one line

Your cheapest energy is almost always your own — the solar your panels make and the power in your battery. Pulse helps you use more of your own energy and lean on the grid less, especially during the expensive evening hours. Small timing changes add up to real money.
...
This is where you land. It answers one question: is my home doing well today?

- A quick greeting and your setup — a reminder of what Pulse is working with (your solar size, battery, heat pump, car).
- Three key numbers, each as a tile:
...
- **Your energy day** sits at the top: a simple colored strip showing the best and worst times to use power today.
  - **Green** — free solar (your panels are making more than the house needs)
  - **Blue** — your battery can cover it
  - **Amber** — grid power, but in a cheaper hour
  - **Red** — avoid: the expensive evening peak
- At a glance you can see, for example, that 11:00–15:00 is the moment to run the car or the dishwasher, and 18:00–21:00 is the time to hold off.
- Detailed reports for each Home number, with a 12-month trend and a plain-language explanation — so you can see how your bill, your exported energy, and your self-sufficiency move across the seasons.

### Assistant — ask anything

A chat that knows your home's energy. Ask it questions the way you'd ask a knowledgeable friend:
...
- **You don't have to log anything.** Pulse reads your home's energy data directly and scores your routines for you.
- **The colored times shift with the seasons.** A sunny summer day is mostly green; a winter day has far less free solar. Pulse always shows today's real shape.
- **Nudges respect your life.** Pulse won't tell you to charge the car at midday if the car isn't usually home then — it suggests realistic changes, like charging on solar on the days you're around.
- **Small changes, real money.** No single nudge is dramatic, but kept up over a month they add up — and Pulse keeps the running total so you can see it.

Welcome aboard. Start on Home, and when a number makes you curious, follow it.
